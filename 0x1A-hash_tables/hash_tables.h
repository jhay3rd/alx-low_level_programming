 ...
 * @key: the key
 * @value: value corresponding to a key
 * @next: points to the next node of the not yet linked list
 * @sprev: points to the previous element of the sorted linked list
 * @snext: points to the next element of the sorted linked list
 */
 ...
 * @size: size of the array
 * @array: array of size
 * @shead: points to the first element of the sorted linked list; while,
